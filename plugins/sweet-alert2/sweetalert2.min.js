!function (e, t) {
    ...
    var e = "swal2-", t = function (t) {
        ...
        a = void 0, l = document.getElementsByClassName(n.container);
    ...
    var s = function (e, t) {
        ...
        if (!document.getElementsByClassName(n.container).length) {
            ...
            var e = p(), t = P(e, n.input), o = P(e, n.file), r = e.querySelector("." + n.range + " input"),
                i = e.querySelector("." + n.range + " output"), l = P(e, n.select),
                s = e.querySelector("." + n.checkbox + " input"), c = P(e, n.textarea);
        ...
        return new Promise(function (e, t) {
            ...
            for (var u = function (t) {
                ...
                var n = e || window.event, o = n.target || n.srcElement, i = w(), a = C(), c = i === o || i.contains(o),
                    d = a === o || a.contains(o);
                switch (n.type) {
                    case"mouseover":
                    case"mouseup":
                ...
                switch (r.input) {
                    ...
                    case"radio":
                        ...
                        c.innerHTML = "", Y = function (e) {
                            for (var t in e) {
                                var o = 1, i = document.createElement("input"), a = document.createElement("label"),
